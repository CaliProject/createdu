...
var vm = new Vue({
    ...
    }, _defineProperty(_methods, 'playMessageSound', function playMessageSound(sent) {
        document.getElementById('message-' + (sent ? 'sent' : 'received') + '-sound');
    }), _defineProperty(_methods, 'readInbox', function readInbox(e) {
        var inbox = e.target,
            $this = this;
    ...
    }), _defineProperty(_methods, 'readAllInbox', function readAllInbox() {
        var ids = [],
            $this = this;
    ...
    }), _defineProperty(_methods, 'openConvoBox', function openConvoBox($index) {
