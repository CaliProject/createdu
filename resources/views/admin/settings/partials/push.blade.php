<div class="panel panel-transparent">
    <div class="panel-heading">
        <h4 class="panel-title">@lang('views.admin.pages.settings.services.push.heading')</h4>
    </div>
    <div class="panel-body">
        <div class="row">
            <blockquote>
                <p>@lang('views.admin.pages.settings.services.push.tips')</p>
            </blockquote>
        </div>
        <div class="row">
            <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-4">
                                    <div class="ios-switch switch-lg">
                                        <input type="checkbox" class="js-switch" name="on"{{ site('pusherOn') == '1' ? ' checked' : '' }}>&nbsp;@lang('views.admin.pages.settings.services.push.pusher.on')
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
