                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-md dropdown-list theme-settings" role="menu">
                            ...
                            <li class="li-group">
                                <ul class="list-unstyled">
                                    <li class="no-link" role="presentation">
                                        @lang('views.admin.navbar.settings.fixed-header')
                                    ...
                                    <li class="no-link" role="presentation">
                                        @lang('views.admin.navbar.settings.fixed-sidebar')
                                        <div class="ios-switch pull-right switch-md">
                            ...
                            <li class="li-group">
                                <ul class="list-unstyled">
                                    <li class="no-link" role="presentation">
                                        @lang('views.admin.navbar.settings.horizontal-bar')
                                        <div class="ios-switch pull-right switch-md">
                                    ...
                                    <li class="no-link" role="presentation">
                                        @lang('views.admin.navbar.settings.toggle-sidebar')
                                        <div class="ios-switch pull-right switch-md">
                                    ...
                                    <li class="no-link" role="presentation">
                                        @lang('views.admin.navbar.settings.compact-menu')
                                        <div class="ios-switch pull-right switch-md">
                                    ...
                                    <li class="no-link" role="presentation">
                                        @lang('views.admin.navbar.settings.hover-menu')
                                        <div class="ios-switch pull-right switch-md">
                            ...
                            <li class="li-group">
                                <ul class="list-unstyled">
                                    <li class="no-link" role="presentation">
                                        @lang('views.admin.navbar.settings.theme-color')
                            ...
                            <li class="no-link"><button class="btn btn-default reset-options">@lang('views.admin.navbar.settings.reset')</button></li>
                        </ul>
                    </li>
                </ul>
