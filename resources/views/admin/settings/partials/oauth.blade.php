    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="@route('admin.settings.save-oauth', ['service' => strtolower($service)], false)"
                ...
                <div class="form-group">
                    <div class="col-sm-8 col-sm-offset-4">
                        <div class="ios-switch switch-lg">
                            <input type="checkbox" class="js-switch" name="on"{{ site(strtolower($service) . 'On') == '1' ? ' checked' : '' }}>&nbsp;@lang('views.admin.pages.settings.services.oauth.on-text')
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">@lang('views.admin.pages.settings.services.oauth.redirect')</label>
                    <div class="col-sm-9">
                        <input class="form-control" value="@route('social-callback', ['service' => strtolower($service)])" name="redirect" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <blockquote>
                        <h4>@lang('views.admin.pages.settings.services.oauth.apply')</h4>
                        <p><a href="{{ $apply_url }}" target="_blank">{{ $apply_url }}</a></p>
                    </blockquote>
                </div>
                <div class="form-group">
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn-primary btn-block">@lang('views.admin.pages.settings.update-button')</button>
                    </div>
                </div>
            </form>
        </div>
